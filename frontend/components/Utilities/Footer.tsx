...
const navigation = {
  social: [
    ...
    {
      name: "Discord",
      href: "https://discord.gg/Wb2HkNcN",
      icon: (
        props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>
      ) => (
    ...
    {
      name: "Email",
      href: "mailto:blitzcrafthqapp@gmail.com",
      icon: (
        props: React.JSX.IntrinsicAttributes & React.SVGProps<SVGSVGElement>
      ) => (
        <svg fill="currentColor" viewBox="0 0 24 24" {...props}>
    ...
    <footer id="contact" className="bg-white dark:bg-black">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-14 lg:px-8">
        <h1 className="text-4xl lg:text-4xl leading-[3rem] text-center text-gray-900 dark:text-white font-black">
          ...
          <Image
            src="/logo.png"
            className="-mt-2.5 h-12 w-12 lg:h-auto lg:w-[40px] ml-1 inline"
            width={96}
            height={96}
            alt="Verificador"
          />
        ...
        <div className="mt-8 max-w-3xl text-xl mx-auto text-center font-semibold text-gray-500 dark:text-zinc-400">
          Building Verificador has been an incredibly fun effort across many
          people at BlitzCraft and our frens at other companies. We&apos;re
          always looking to make Verificador better, so please let us know how
          we can improve.
        </div>
        ...
        <p className="mt-8 text-center text-sm leading-5 text-gray-500 dark:text-zinc-500">
          &copy; 2023 BlitzCraft. All rights reserved.
        </p>
      </div>
    </footer>
  );
